...
requirements: llama-index, llama-index-llms-ollama, llama-index-embeddings-ollama, openmetadata-ingestion==1.7.0, pydantic>=2.0
"""
...
class Pipeline:
    ...
    def pipe(
        ...
        # Define a custom prompt template with a welcome message
        metadata_prompt = PromptTemplate(
              """
              Welcome to the OpenMetadata Insights Assistant! I'm here to help you explore and understand your metadata.
              
              Given the OpenMetadata context below, provide a detailed, structured response to the user query.
        ...
        # Run the query with the custom template
        query_engine = self.index.as_query_engine(
            text_qa_template=metadata_prompt,
            streaming=True
        )
